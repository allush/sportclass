            ...
            this.each(function(){
                ...
                j.bind("Init",function(l,m){
                    ...
                    if(l.features.dragdrop&&l.settings.dragdrop){
                        ...
                        c("#"+k+"_filelist").append('<li class="plupload_droptext">'+a("Перетащите сюда файлы")+"</li>")
                    }
